...
/**
 * class representing a plane in 3-space given by an equation 
 * or a vector representation
 * @author huub
 */
...
{   
	/**
	 * equation representation: all vectors x with (normal,x)=(normal,point) 
	 * where normal is a unit normal vector to the plane and point is a point 
	 * in the plane
	 */
    Vector3D normal, point;
    /**
     * vector representation: all vectors of the form
    ...
    /**
     * make a deep copy of this plane3D
     ...
     * @param v translate vector
     * @return this plane3D translated over v
     */
    ...
    /**
     * find the rotation of this plane around Line3D line over an angle of theta radians
     * @param line rotation axis
     * @param theta rotation angle in radians
     * @return this plane3D rotated
     */
    ...
    /**
     * check if this plane contains vector v, i.e. (n,v)-(n,p) is "small"
    ...
    /**
     * find the position of Vector3d v relative to this plane, using
     * the representation (n,x)=(n,p) or (n,x)-(n,p) = 0 
     * @param v vector whose position relative to this plane3D must be found
     * @return -1 ("left"), +1 ("right") or 0 ("on")
     */
     ...
     * 0 = line parallel to plane, 1 = intersection in a point,
     ...
     * 0 = the planes are parallel, 1 = the planes intersect in a line,
    ...
    /**
     * check if the point v which is assumed to be in the plane through v1, v2, v3
     * is an inner point of the 3D triangle v1, v2, v3
     * v1, v2, v3 MUST span a plane
     * @param v1 first spanning vector of plane 
     * @param v2 second spanning vector of plane
     * @param v3 third spanning vector of plane
     * @param v point of the plane to be checked
     * @return true/false
     */
