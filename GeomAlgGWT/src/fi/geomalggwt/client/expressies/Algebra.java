...
*/		
/*		
		else if(e1 instanceof PoissonCDF && e2 instanceof PoissonCDF)
		{	return zijnGelijk(e1.kind1,e2.kind1,vorm) && zijnGelijk(e1.kind2,e2.kind2,vorm);
		}
*/		
/*		
...
*/	
	 ...
	 *te vergelijken (daardoor slecht één variabele mogelijk).
...
/*		
		...
		{   int macht = (int)exp.kind2.geefWaarde();
			...
			if(exp.kind1.geefWaarde()<0){   
				...
				return exp = new Aftrekking(new BasisExpressie(0),b);
	        }
			else {
				BasisExpressie b = new BasisExpressie(exp.geefWaarde());
				b.setScientificNotation(true, macht, signf);
...
*/
/*		
		if(exp instanceof SigRoundStandard)
		{   int signf = (int)exp.kind2.geefWaarde(); 
			
			if(exp.geefWaarde()<0){   
				BasisExpressie b = new BasisExpressie(-exp.geefWaarde());
				b.setScientificNotation(true, signf);
				return exp = new Aftrekking(new BasisExpressie(0),b);
	        }
			else {
				BasisExpressie b = new BasisExpressie(exp.geefWaarde());
