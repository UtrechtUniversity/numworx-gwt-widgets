...
//Rectangle raakRectangle = new Rectangle(xPos + standLinks - 3, yPos, 16, 13);
...
//System.out.println("paint standRechts " + standRechts);       	 	
//Rectangle raakRectangle = new Rectangle(xPos + standRechts - 3, yPos, 16, 13);
//g.rect(raakRectangle.x, raakRectangle.y, raakRectangle.width, raakRectangle.height);
//g.stroke();
...
// 	}
	...
	{	
//System.out.println("zetStandRechts " + std);
