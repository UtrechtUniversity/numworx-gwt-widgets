...
public class Text_en {
    ...
    {	"feedbackTekstTekenGrafiek", "Pay attention: also draw the graph."},
    {	"feedbackTekstTeWeinigPunten", "Let op: je hebt nog niet voldoende punten getekend."},
    {	"feedbackTekstTeWeinigPunten", "Pay attention: an insufficient amount of points are drawn."},
    	
	{	"fc_huidigDomein", "Domein is nu: "},
	{	"fc_huidigDomein", "The domain is now: "},
