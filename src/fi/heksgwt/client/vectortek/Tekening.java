...
*/
/*	
	public Tekening(int x, int y, int b, int h, AppletUtil au, String naam, boolean log) 
	{
		super();
		relx = x;
		rely = y;
...
/*	
	public Hashtable<String,Object> getState()
	{
		...
		h.put("hoogte", hoogte);
		h.put("aantaltekenobject", aantalTekenObj);
...
//if (!naam.equals(""))
//{
//	gr.setStrokeStyle(CssColor.make(0,255,0));
//	gr.strokeRect(xPos, yPos, breedte, hoogte);
//}
		
		if (!visible)
			return;
//if (!naam.equals(""))
//System.out.println(naam + " " + aantalTekenObj);
...
//if (!naam.equals(""))
//System.out.println(naam + " loc schaal = " + getLocation().x + "," + getLocation().y);			
