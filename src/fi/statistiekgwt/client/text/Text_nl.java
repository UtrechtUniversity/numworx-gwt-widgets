	...
	static final Object[][] contents =
		{
				...
				{ "mode", "Modus" },
				{ "minimumIs", "minimum = " },
				{ "tukeyMinimumIs", "kleinste niet-uitschieter = " },
				{ "firstQuartileIs", "1e kwartiel = " },
				{ "medianIs", "mediaan = " },
				{ "thirdQuartileIs", "3e kwartiel = " },
				{ "maximumIs", "maximum = " },
				{ "tukeyMaximumIs", "grootste niet-uitschieter = " },
				{ "valueIs", "waarde = " },
				{ "sortItem", "Sorteer" },
				...
				{ "pasteclipboardMessage",
					"Plak de data in het tekstvak en klik op " },
				{ "pasteclipboardMessage2",
					"Scheid de waarden met ';' of tab. Zet iedere rij op een nieuwe regel met 'Enter'." },
				{ "importPastedDataButton", "Importeer" },
				{ "importPastedDataFailMessage",
					"De data heeft niet het goede formaat." },
				{ "resetButton", "Reset" },
				...
				{ "noCSVMessage",
					"Het gekozen bestand is geen CSV-bestand. Kies een CSV-bestand (.csv). "
				...
				{ "notHTML5ReadyMessage",
					"Sla de statistiekcomponent opnieuw op in de auteursomgeving "
				...
				{ "removeViewWarning",
					"Weet je zeker dat je deze view wilt verwijderen?" },
