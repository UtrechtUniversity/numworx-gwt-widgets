...
{	
	 ...
	 * @param b breedte
	 * @param h hoogte 
	 * @param ct2d Context2d voor tekenen
	 * @param o eigenaar
	 */
	...
	/**
	 * er is een pijlenketting verander, verwijder goed-V/fout-X en
	 * informeer AlgebraPijlenGWT (zie aldaar) 
	 */
	...
	/**
	 * zet een beginExpressie, i.e. een UVS met de Expressie exp erin (deze komt uit de launchdata)
	 * @param exp de beginExpressie
	 */
	...
	/**
	 * getState voor het hele werkveld: Lists met de class names, x-posities, y-posities en States van alle ASC's
	 * op het werkveld, List voor verbindingen van ASC's met Pijlen en zoomStates voor alle variabelen   
	 * @return een HashMap
	 */
	...
	/**
	 * gebruikt in init(....): bewaar de initiele State in
	 * editmodeState, en setState
	 * @param h de docentdata
	 */
	...
	/**
	 * set de State van het werkveld m.b.v. map: map bevat Lists met de class names, x-posities, y-posities en States van alle ASC's
	 * op het werkveld, List voor verbindingen van ASC's met Pijlen en zoomStates voor alle variabelen
	 * @param map de Map met alle State info 
	 */
	...
	/**
	 * de ASC acc is op het werkveld gesleept, maak dus een nieuwe kopie voor
	 * de stapel
	 * @param asc de versleepte ASC
	 */
	...
	/**
	 * zet de nieuwe zoomState voor elke UitvoerSchuifComponent en de GrafiekComponent indien deze de variabele varnaam bevatten  
	...
	/**
	 * aktie bij gebruik links/rechts knop (klasse AlgebraPijlenGWT): verander de pijlrichting 
	 * van de stapels
	 */
	...
	/**
	 * wis het werkveld: als er geen docentdata zijn, verwijder alle ASC's, maak nieuwe
	 * stapels, maak als nodig een nieuwe GrafiekComponent en maak nieuwe zoomStates; 
	 * als er wel docentdata zijn, zet die dan terug via SetState 
	 */
	...
	/**
	 * maak (als nodig) een GrafiekComponent en toon die resp. verwijder de GrafiekComponent
	 * @param b true/false
	 */
	...
	/**
	 * vindt de TabelCompoment (als die er is) die het punt met coordinaten (eventX,eventY) bevat
	 * zie methode contains() in klasse TabelComponent
	 ...
	 * @param eventX de x-coordinaat van het MouseMove/TouchMove Event
	 * @param eventY de y-coordinaat van het MouseMove/TouchMove Event
	 */
	 ...
	 * @param eventX de x-coordinaat van het MouseUp/TouchEnd Event
	 * @param eventY de y-coordinaat van het MouseUp/TouchEnd Event
	 */
