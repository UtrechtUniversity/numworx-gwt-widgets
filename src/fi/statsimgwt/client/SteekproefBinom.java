...
public class SteekproefBinom extends FlowPanel implements ClickHandler, KeyUpHandler {
	TextBox muText;
	TextBox sigmaText;
	Label muLabel1;
	Label sigmaLabel1;
	...
	public SteekproefBinom(StatSimGWT ssgwt, boolean steekproefLinkerTabel, boolean steekproefRechterTabel) {
		this.ssgwt=ssgwt;
	...
	public void fireCBook() {
		...
		List<SteekproefBinom.Experiment> list = (List<SteekproefBinom.Experiment>) dataProvider.getList();
		List<SteekproefBinom.Experiment1> list1 = (List<SteekproefBinom.Experiment1>) dataProvider1.getList();
