...
public class DeelSchuifComponent extends AlgebraSchuifComponent 
{	
	Expressie waarde;
	//Font f;
	//FontMetrics fm;
	...
	{	Expressie uitv = new Expressie();
		...
		{	uitv = new Deling(e1, ve2);
		}
		else if (e1 == null && ve1 != null && e2 != null)
		{	uitv = new Deling(ve1, e2);
		}
		else if (ve1 != null && ve2 != null)
			uitv = new Deling(ve1, ve2);
		else
			return null;
		return uitv;
	}
