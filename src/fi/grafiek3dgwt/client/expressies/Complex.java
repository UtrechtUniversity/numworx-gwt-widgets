...
*/
	        ...
	        public void timesEquals(double a){
	                boolean test = true;
	                if(Complex.infOption){
	                    if((this.isInfinite() && a!=0.0D) || (isInfinity(a) && !this.isZero())){
	                        this.real = Double.POSITIVE_INFINITY;
	                        this.imag = Double.POSITIVE_INFINITY;
	                        test = false;
	                    }
	        ...
	        public static Complex over(Complex a, double b){
	                Complex c = new Complex(0.0D, 0.0D);
	                if(Complex.infOption && isInfinity(b))return c;
	        ...
	        public static Complex over(double a, Complex b){
	                Complex c = new Complex();
	                if(Complex.infOption && !isInfinity(a) && b.isInfinite())return c;
	        ...
	        public Complex transposedOver(double a){
	                Complex c = new Complex(0.0D, 0.0D);
	                if(Complex.infOption && !isInfinity(a) && this.isInfinite())return c;
	        ...
	        public static Complex pow(Complex a, Complex b ){
	                // foutje als a gelijk aan 0?? daarom onderstaande aanvulling
	        		if(Math.abs(a.real)<0.00000000000000001 && Math.abs(a.imag)<0.00000000000000001)return new Complex(0.0D);
	        		//
	        		Complex c = new Complex();
	        ...
	        public static Complex sin(Complex aa ){
	                ...
	                double a = aa.real;
	                double b = aa.imag;
	                c.real = Math.sin(a)*cosh(b);
	                c.imag = Math.cos(a)*sinh(b);
	                return c;
	        }
	        ...
	        public static Complex cos(Complex aa ){
	                ...
	                double a = aa.real;
	                double b = aa.imag;
	                c.real= Math.cos(a)*cosh(b);
	                c.imag= -Math.sin(a)*sinh(b);
	                return c;
	        }
	        ...
	        public static Complex tan(Complex aa ){
	                ...
	                Complex x = new Complex(Math.sin(a)*cosh(b), Math.cos(a)*sinh(b));
	                Complex y = new Complex(Math.cos(a)*cosh(b), -Math.sin(a)*sinh(b));
	                c=Complex.over(x, y);
	                return c;
	        }
	        ...
	        public static boolean isEqualDiff(Complex a, Complex b, double diff){
                boolean test = false;
                if(isNaN(a)&&isNaN(b)){
                        test=true;
                }
                	...
                	if(Math.abs(a.real - b.real) < diff && Math.abs(a.imag - b.imag) < diff)test = true;
                }
                return test;
        }
	        ...
	        public static boolean isEqualWithinLimits(Complex a, Complex b, double fract){
	            ...
	            if(!test){
	                ...
	                idn=Math.abs(ib);
	                if(Math.abs(ia)>idn)idn=Math.abs(ia);
	                //if(Math.abs(ra-rb)/rdn<fract && Math.abs(ia-ia)/idn<fract)test=true; fout!!
	                if(Math.abs(ra-rb)/rdn<fract && Math.abs(ia-ib)/idn<fract)test=true;
