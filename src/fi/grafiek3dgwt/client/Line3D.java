...
/**
 * class representing a line in 3-space, as either
 * the points of the form support+lambda*direction
 * or all points of the form lambda*(point2-point1),
 * that is all points on the line through segment 
 * [point1,point2]
 * @author huub
 */
...
{   
     ...
     * constructor using vector representation is not allowed
    ...
    /**
     * find the translate of this line by Vector3D v
    ...
    /**
     * check if the end point of Vector3d v is on this line
    ...
    /**
     * check if the end point of Vector3d v is on the segment [point1,point2]
     * @param v Vector3D to be checked
     * @return true/false
     */
    public boolean segmentContains(Vector3D v)
    {   boolean cont = contains(v);
        // v should be on the line; v is on the segment if v is
        // between point1 and point2 (or equals one of both)
    	// so the distance between point1 and point2 should be
    	// less then or equal to the sum of distances v-point1 and 
    	// v-point2
        if (cont)
    ...
    /**
     * check if the end point of Vector3d v is an inner point the segment [v1,v2]
     * @param v1 first point of segment
     * @param v2 second point of segment
     * @param v Vectro3D to be checked
     * @return true/false
     */
    ...
    /**
     * check if the points v1,v2,v3 are collinear, points assumed different! 
    ...
    /**
     * find type of intersection type of line1 and line2: <br>
     * 0 = the lines cross, 1 = the lines intersect in a point,
     * 2 = the lines coincide 
     * @param line1 first line
     * @param line2 second line
     * @return code for intersection type
     */
    ...
    {   
        ...
        // if the directional vectors are not multiples of each other
    ...
    /**
     * redefine equals on Object for method contains() in class Vector
     */
     ...
     * so intersection type should equal 1
     * @param line1 first line
     * @param line2 second line
    ...
    /**
     * rotate Vector3D v over an angle theta (radians) around the direction
     * of this line, anticlockwise when looking along the direction of this line;
     * @param v Vector3D to be rotated
    ...
    {   if (contains(v))
        ...
        // plane has normal vector direction and v is on this 
        ...
        // if we are rotating anticlockwise when looking along direction
