package fi.weblogogwt.client.formuleobjects;
...
{		
	private static boolean woordFormule = true;
	...
	{	Expressie exp = null;
		...
		{	exp = new BasisExpressie(Double.valueOf(s).doubleValue());
			//if("MW".equals(WiskOpdr.deployVariant)) exp = new BasisExpressie(s);
			return exp;
		}
// correctie GWT,s.charAt(0)=='\u03C0' werkt niet 		
		if(s.equals("\u03C0"))
		{
			exp = new PI();
			return exp;
...
//		is het een arcsinus
	...
	public static String randomizeString(String s, String[] randomVars, HashMap randomValues) throws Exception
	{	for(int i=s.length()-1 ; i>-1; i--)
		{	if(s.charAt(i)=='@')
	...
	public static String randomizeTekstVakString(String tekst, String[] randomVars, HashMap randomValues) throws Exception
