...
sh update-app-az-dev.sh BalansFruitGWT balansfruitgwt BalansFruitGWT
sh update-app-az-dev.sh BinomVerdGWT binomverdgwt BinomVerdGWT
sh update-app-az-dev.sh CalculatorGWT calculatorgwt CalculatorGWT
sh update-app-az-dev.sh DoorzienGWT doorziengwt DoorzienGWT
sh update-app-az-dev.sh DraaibankGWT draaibankgwt DraaibankGWT
sh update-app-az-dev.sh GeomAlgGWT geomalggwt GeomAlgGWT
sh update-app-az-dev.sh Grafiek3DGWT grafiek3dgwt Grafiek3DGWT
sh update-app-az-dev.sh GraphToolGWT graphtoolgwt GraphToolGWT
...
sh update-app-az-dev.sh StroomDiagrammenGWT stroomdiagrammengwt StroomDiagrammenGWT
sh update-app-az-dev.sh TegelsLeggenGWT tegelsleggengwt TegelsLeggenGWT
sh update-app-az-dev.sh TekenVeelvlakGWT tekenveelvlakgwt TekenVeelvlakGWT
sh update-app-az-dev.sh VerknippenGWT verknippengwt VerknippenGWT
