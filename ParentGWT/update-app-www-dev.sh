...
azcopy sync $3.css https://numworxprod.blob.core.windows.net/cds/apps/$3.css?"$SAS"
azcopy sync $2/ https://numworxprod.blob.core.windows.net/cds/apps/$2/?"$SAS" --recursive=true --delete-destination true
